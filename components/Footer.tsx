          ...
          <ul className="space-y-3 text-sm font-medium">
            ...
            <li className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                <a
                  href="https://chat.whatsapp.com/FboiKzrHqxU2E07rWwstnz"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://wa.me/918590330421"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-emerald-400 transition-colors block text-brand-yellow-light/70"
                >
                  Message us: +91 8590330421
                </a>
                <a
                  href="https://wa.me/917012264390"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-emerald-400 transition-colors block text-brand-yellow-light/70"
                >
                  Message us: +91 7012264390
                </a>
              </div>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a
                href="mailto:riteshrnair345@gmail.com"
                className="hover:text-blue-400 transition-colors"
              >
                riteshrnair345@gmail.com
              </a>
            </li>
          </ul>
        </div>
